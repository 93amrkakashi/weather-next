...
function loadNavbar() {
  ...
  navbar.innerHTML  = ""
  let content = `
  <div class="w-full px-4  md:flex md:justify-between">
        <div class="flex justify-between items-center">
          <a class="logo navbar-btn" href="./index.html" title=" ">
            <img src="images/logoo.svg" alt=" ">
            <!-- <span class="font-bold">اى لوجو</span> -->
          </a>
          <button class="text-3xl md:hidden" id="navbar-toggle">
            <i class="fas fa-bars"></i>
          </button>
        </div>
        <div class="hidden md:flex flex-col md:flex-row items-center gap-6 mt-3 md:mt-0 md:justify-between md:w-[80%]"
          id="navbar-collapse">
          <ul class="flex justify-center items-center flex-col md:flex-row gap-5 ">
            <a href="./sat.html" data-translation="nav1" class="nav    px-12 text-[18] font-[700] p-2 lg:px-4 md:mx-2 "></a>
            <a href="./index.html" data-translation="nav2" class="nav   px-12 text-[18] font-[700] p-2 lg:px-4 md:mx-2 "></a>
          </ul>
          <!-- search -->
          ...
          <select id="languageSelect" class="bg-[#0167b4] max-w-[130px] h-[40px] rounded-3xl text-white px-3 mx-12"
            onchange="changeLanguage()">
            <option value="ar" class="px-12 text-lg font-bold p-2 lg:px-4 md:mx-2 text-white">العربية</option>
            <option selected value="fr" class="px-12 text-lg font-bold p-2 lg:px-4 md:mx-2 text-white">Français</option>
          </select>
        </div>
      </div>
  `
